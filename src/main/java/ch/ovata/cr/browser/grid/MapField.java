/*
 * $Id: MapField.java 2898 2019-12-19 15:42:42Z dani $
...
public class MapField extends CustomField<Value> {
    ...
    private void onEdit( ClickEvent<Button> event) {
        new EditMapDialog( this.vf, this.value, this::onSave).open();
    }
    
    private void onSave( Value value) {
        this.value = value;
